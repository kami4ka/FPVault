 ...
 *
 * sdcard.c - SD/MMC card layer, from F1C100s_projects sd_card_test (GPL-3)
 * with watchdog feeds and a realistic ACMD41 poll interval added (see
 * src/sdc.c's header for the incident that motivated them).
 */
#include <stdint.h>
#include <stddef.h>
