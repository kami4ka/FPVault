...
/* pipeline-facing bench tools */
void enctest_dump_pipeline(void); /* 'j' while the pipeline runs: newest frame */
...
void enctest_probe_coef(void);    /* 'H': map the frontend coefficient RAM */
