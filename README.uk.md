...
```
CVBS-камера ──> TVD (ТВ-декодер, власний DMA) ──> DDR (кільце semi-planar YUV422)
                                                   │
                                                   ▼
                                    апаратний JPEG-кодер Cedar VE
                                                   │  кільце бітстріму
                                                   ▼
                              SD-карта, 4-біт @ 50 МГц + дескрипторний DMA
                                                   ▼
                            /DCIM/100FCDVR/FCDV0001.AVI  (іменування DCF)
```
...
- **Вбудований USB-кардридер** — під'єднайте плату до комп'ютера, і
  SD-карта змонтується як USB-накопичувач ("DVR SD Card"): карту виймати не
