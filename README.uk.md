...
- [x] M6 — RunCam Device Protocol наживо на UART1 (Betaflight/INAV/
      ...
      попереду*
- [ ] M7 — витривалість і загартування ін'єкцією відмов — *крешостійкість
      підтверджена на 5 реальних раптових зникненнях живлення: кожен кліп
      відтворюється до 1 кадру (33 мс) перед обривом; ін'єкція затримок SD
      пройдена; безперервний годинний запис ще попереду (заблоковано
      стабільним стендовим живленням — див. docs/HARDWARE-ERRATA.uk.md)*
