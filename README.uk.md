...
microSD, піни CVBS `TV IN` і гребінка `TV_OUT`, PMIC EA3059C. SW2 замикає
пін NOR: тримайте її під час підключення USB — і BROM чипа потрапляє у
відновлювальний FEL, тож плату завжди можна перепрошити самим лише USB,
без UART (див. [docs/BRINGUP.uk.md](docs/BRINGUP.uk.md)). Особливості
